...
describe("Feature: Terminals shell toolbar contract", () => {
  ...
  test("Scenario: Given terminal history is now an explicit app surface When reading the workbench source Then the shell exposes a dedicated History tab and route-specific active tab ids", () => {

...
export const SnapshotHydratesViewportBeforeTransportReconnect = {
  name: "Scenario: Given durable snapshot truth When the terminal route hydrates before transport reconnect Then the viewport renders without app chrome and stays readable",
  args: {
    surfaceWidthPx: 1280,

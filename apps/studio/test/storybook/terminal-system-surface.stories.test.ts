...
describe('Feature: Storybook DOM contract for terminal system surface', () => {
	...
	test('Scenario: Given durable snapshot truth When the terminal route hydrates before transport reconnect Then the viewport renders without app chrome and stays readable', async () => {

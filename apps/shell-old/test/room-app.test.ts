  ...
  await startCliShellRoomApp({
    ...
    attached: {
      ...
      terminal: {
        ...
        granted: false,
        focused: true,
        bindingMetadata: { appId: "cli-shell", resourceKey: "shell-5", ownerSystem: "terminal-system" },
      },
      room: {
        ...
        granted: false,
        focused: true,
        bindingMetadata: { appId: "cli-shell", resourceKey: "shell-5", ownerSystem: "message-system" },
      },
      binding: {
        appId: "cli-shell",
        resourceKey: "shell-5",
...
describe("Feature: cli-shell OpenTUI room input", () => {
  ...
  test("Scenario: Given the composer uses cli-shell app keybindings When the user presses Enter and Shift+Enter Then Enter sends while Shift+Enter keeps multiline editing", async () => {
    const room = await startRoom();

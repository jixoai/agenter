...
import { buildCliShellComposedSurface, toAppTerminalComposedSurface } from "./composed-surface";
import {
  routeCliShellKey,
...
export class CliShellCoreApp {
  ...
  #syncSourceMirror(input: {
    ...
    // a self-feeding paint loop when a app terminal has no live transport yet.

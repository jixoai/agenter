...
describe("Feature: shell renderable mux boundary", () => {
  test("Scenario: Given renderable mux source files When inspected Then app and tmux-host concepts stay outside the core", () => {
  ...
  test("Scenario: Given shell source files When inspected Then legacy shell package imports stay out of shell", () => {
    ...
    const forbiddenImports = [
      'from "agenter-app-shell',
      "from 'agenter-app-shell",
      'require("agenter-app-shell',
      "require('agenter-app-shell",
      "apps/shell-old",
      'from "../shell-old',
      "from '../shell-old",

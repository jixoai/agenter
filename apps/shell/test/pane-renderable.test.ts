...
describe("Feature: shell protocol-backed PaneRenderable", () => {
  ...
  test("Scenario: Given frame replay debug hook When pane refreshes Then it records source revision without app logger coupling", async () => {

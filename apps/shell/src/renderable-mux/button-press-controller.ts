...
export interface ShellButtonPressControllerInput<ActionId extends string> {
...
export class ShellButtonPressController<ActionId extends string> {
  readonly #resolveAction: (event: MouseEvent) => ActionId | null;
  readonly #onClick: (action: ActionId, event: MouseEvent) => void;
  ...
  constructor(input: ShellButtonPressControllerInput<ActionId>) {

...
export interface ShellBaseAppArgs {
...
export interface ShellAttachArgs extends ShellBaseAppArgs {
...
export const isShellMetadataOnlyAppArgv = (argv: readonly string[]): boolean => {

...
The system SHALL allow clients to inspect workspace settings layers and effective merged settings by `workspacePath` without starting or selecting a session.

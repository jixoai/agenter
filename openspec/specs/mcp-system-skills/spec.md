# mcp-system-skills Specification

## Purpose
Define the built-in MCP runtime skill that teaches AI agents how to discover and use the root-workspace `mcp` CLI without becoming a second MCP registry or lifecycle owner.

# message-query Specification

## Purpose

Define the message-system's authorized room-history query contract, including room-scoped search, guarded read-only SQL, and rebuildable index projection law.

# avatar-seat-identity-allocation Specification

## Purpose
Define how workspace seat documents allocate isolated Avatar principals and avoid leaking one seat's identity into another.

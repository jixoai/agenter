# attention-source-navigation Specification

## Purpose
Define the durable source-jump contract from attention detail into global room and terminal browsing surfaces.

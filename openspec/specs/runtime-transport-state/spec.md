...
Define the runtime transport lifecycle exposed by the client SDK so application surfaces can distinguish connecting, reconnecting, connected, and offline behavior while live subscriptions recover across reconnects.

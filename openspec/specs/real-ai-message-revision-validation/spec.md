# real-ai-message-revision-validation Specification

## Purpose
Define the opt-in real-provider validation flow that proves room-message draft correction through durable `edit` and `recall` behavior.

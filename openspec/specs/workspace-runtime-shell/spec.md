...
The WebUI SHALL expose running-avatar detail through a secondary runtime shell that is entered from `Running Avatars` or from workspace-local avatar or session actions, rather than through primary application navigation.

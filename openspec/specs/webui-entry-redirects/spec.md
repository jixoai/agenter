...
Define the durable route-entry law for redirect-only WebUI pages so first-level navigation lands on canonical destinations without rendering an intermediate error surface.

...
Define the durable styling contract for Lit-based shared web-components so downstream clients can theme public surfaces without reopening shadow-private internals.

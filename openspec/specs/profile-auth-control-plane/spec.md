...
## Purpose
Define the proof-bearing authentication flows that allow canonical profiles to be created, resumed, and linked without treating raw identifiers as long-lived bearer credentials.

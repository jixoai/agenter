# terminal-theme-profile Specification

## Purpose

Define the durable terminal theme identity and shared theme-token law consumed by viewport hosts and renderer adapters.

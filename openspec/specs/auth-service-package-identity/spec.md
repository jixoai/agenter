# auth-service-package-identity Specification

## Purpose
Define the canonical package, CLI, runtime, and vocabulary identity for the auth authority. Legacy `profile-*` names remain compatibility aliases only; profile remains a domain object term.

# real-ai-project-room-collaboration-validation Specification

## Purpose
Define the opt-in real-provider validation flow that proves shared project-room collaboration across multiple Avatar runtimes.

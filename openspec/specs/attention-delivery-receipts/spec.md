# attention-delivery-receipts Specification

## Purpose

Define durable delivery-attempt and receipt law so AI acceptance, failure, and completion remain distinct from attention commits, read-state, and `ai_call` lifecycle.

# sidebar-scaffold-layout Specification

## Purpose
Define the shared static `sidebar + content` scaffold law used by routes, dialogs, and shared package demos that do not need stateful right-detail behavior.

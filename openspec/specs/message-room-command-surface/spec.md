# message-room-command-surface Specification

## Purpose

Define the durable command-surface law for explicit room targeting, explicit room-state errors, and the retirement of top-level `chat.*` truth-facing surfaces.

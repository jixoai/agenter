# shell-next-terminal-interaction-ownership Specification

## Purpose
TBD - created by archiving change rework-shell-next-terminal-interaction-ownership. Update Purpose after archive.
## Requirements

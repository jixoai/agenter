# overlay-rule-fs Specification

## Purpose
Define the reusable ordered-glob filesystem authority that backs WorkspaceSystem shell mounts and private asset isolation.

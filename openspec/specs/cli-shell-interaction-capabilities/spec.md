...
Define app-local cli-shell interaction capability recommendations for offscreen terminal projection. These recommendations describe which terminal-like interaction enhancements cli-shell should provide when a backend does not supply the behavior at the projected surface.

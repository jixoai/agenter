...
If open issues block exit, name them here and explain what blocks them, so the next iteration knows where to resume.
...
4. `issues/` - iteration findings discovered during implementation.

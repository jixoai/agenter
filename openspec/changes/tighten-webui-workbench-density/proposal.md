...
- `message-system-surface`: tighten the compact room-toolbar contract so viewer identity, room actions, and body-mode chips stay visible inside the fixed toolbar band on mobile.

...
- [x] 1.1 Add a behavior test proving `check` accepts free-form non-empty `review/self-review.md` and `review/self-review.html` files.
...
- [x] 3.3 Produce free-form `review/self-review.md` plus `review/self-review.html`, run `bun run openspec:vision -- check harden-vision-driven-proof-gates`, and confirm it passes without rigid section rules.

...
| ---- | ------- | -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| 1    | User    | Self-review the new schema.                                                                                                | The workflow itself is the product under test.                                                                  |
...
The user does not want a decorative workflow. They want a development law that survives real use, catches fake completion, and produces artifacts that a product architect can trust without reading implementation code.
...
- [x] 2. Write a durable spec for stronger proof gates.
- [x] 3. Add BDD tasks that fail on fake self-review proof and pass on real proof.
- [x] 4. Implement controller/template/test updates.

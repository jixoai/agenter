...
- Round: 3
- Status: User reported a bug and corrected the workflow: record the user's requirements objectively in this change before iterating development.
- Previous plan backup: `plans/plan-v1.md` was created before this Round 3 material plan correction.
...
- Browse owns three explicit scroll owners:
  - notebooks

...
- [x] 2.4 Keep the shared read-progress affordance at the message bubble inline-end for both participant and viewer-owned rows
...
- [x] 4.4 Verify in the browser that viewer-owned Room messages keep the read-progress trigger on the bubble inline-end

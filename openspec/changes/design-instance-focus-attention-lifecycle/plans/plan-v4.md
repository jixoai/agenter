...
- `msg:<from>/<to>` is an open candidate for the messageSystem world: a contact/delivery route, meaning "this actor/source can send to that actor/target" or "deliver through this route".
...
- `msg:` is the line / route / contact ability for sending.

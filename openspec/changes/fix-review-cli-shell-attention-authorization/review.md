...
4. cli-shell has improved its current-bound-terminal subscription law, but the popup is still a projection over approval request rows rather than an attention-backed terminal action.

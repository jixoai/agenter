...
- **GIVEN** cli-shell current bound terminal is `T`
...
- **THEN** the requested bound-terminal command executes without requiring the user to send a second instruction telling the model to retry

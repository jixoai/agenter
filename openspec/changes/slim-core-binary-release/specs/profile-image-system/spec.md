...
- **AND** repeated requests for the same session return visually stable fallback output
...
- **AND** repeated requests for the same identity return visually stable fallback output

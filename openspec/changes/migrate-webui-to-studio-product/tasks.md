...
- [x] 1.1 Record the breaking decisions in proposal, design, and delta specs: `agenter web` removed, `agenter studio` productized, `@agenter/webui` renamed to `agenter-ext-studio`, and `@agenter/ui-studio` renamed to `@agenter/icon-studio`.
...
- [x] 2.1 Add a `studio` product descriptor that resolves to `agenter-ext-studio` without importing Studio implementation code.
...
- [x] 5.3 Update README and asset documentation for `agenter studio`, `agenter-ext-studio`, and `@agenter/icon-studio`.

...
- Preserve cli-shell/core separation: this is app TUI presentation behavior only and does not change TerminalSystem, MessageSystem, AvatarRuntime, or authorization truth.
...
- `cli-shell-app`: default Chat startup layout, singleton Chat reopen behavior, and tmux popup/status-bar mouse interaction law.

## Impact

- `apps/cli-shell` tmux host planning, app settings, help text, README, and BDD tests.
- `openspec/specs/cli-shell-app/spec.md` and package durable spec text.

...
- [x] 4.4 Remove the mistaken bootstrap-only summary layer so runtime bootstrap returns to `context -> items`, while compact summary remains prompt-window memory instead of a new bootstrap document.

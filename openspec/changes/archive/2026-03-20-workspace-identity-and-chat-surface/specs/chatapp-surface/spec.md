...
The WebUI SHALL provide a reusable ChatApp surface for workspace Chat that composes the conversation viewport, attachment tray, preview affordances, message-bubble expert action affordances, and the shared AI composer as independent project-local components.

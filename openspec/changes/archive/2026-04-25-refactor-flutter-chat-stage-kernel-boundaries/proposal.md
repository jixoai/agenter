...
- Split large stage widgets into smaller transcript, composer, notice, and row primitives without changing product-shell behavior.
- Keep product shell profile persistence and navigation inside `packages/flutter-chat-view/example`; do not touch `packages/webui`.

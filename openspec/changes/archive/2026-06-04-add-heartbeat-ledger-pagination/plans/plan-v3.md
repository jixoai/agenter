...
- Renders the list row as a top/middle/bottom structure:
  ...
  - middle: metro-platform timeline from start to first frame and later message parts;
  - bottom: one-line optional summary plus compact auxiliary facts.
- Condenses long middle processes by showing head/tail stations and a statistical middle station such as `thinking 19.2s / tool x1`.

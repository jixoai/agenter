...
- [x] 2.1 Refactor `packages/flutter-chat-view` so the chat stage can compose inside a host-owned shell without package-owned page chrome.
- [x] 2.2 Add transcript affordances for restrained time dividers, message selection, and return-to-latest behavior.

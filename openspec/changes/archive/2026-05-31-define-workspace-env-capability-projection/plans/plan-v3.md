...
- Round: 3
- Status: NoteSystem CLI design captured: Markdown + frontmatter, notebook/section/page hierarchy, strict write modes, draft notebook shortcut, and lightweight JS search.

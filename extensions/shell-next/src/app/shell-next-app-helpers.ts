...
import { isShellNextKeyHandled } from "./key-event-scope";

export const readShellNextKeyEvent = (value: unknown): KeyEvent | null =>
  typeof value === "object" && value !== null ? (value as KeyEvent) : null;

export const shouldShellNextSkipKey = (key: KeyEvent): boolean => isShellNextKeyHandled(key);
...
export const defaultShellNextStatusbarState: ShellNextStatusbarState = {
  runtime: { label: "Idle" },

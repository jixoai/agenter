...
export class FakeShellNextStore implements ShellNextStore {
  ...
  async publishGlobalTerminalComposedSurface(): Promise<unknown> {
    throw new Error("composed TerminalSystem surface must not be used by active shell-next");
  }

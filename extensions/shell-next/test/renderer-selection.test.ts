...
import { createShellNextRendererSelectionBehavior } from "../src/renderable-mux/renderer-selection";
...
const startSelectionHarness = async (): Promise<{
  ...
  const behavior = createShellNextRendererSelectionBehavior({
...
describe("Feature: shell-next renderer semantic selection plugin", () => {

# agenter-ext-shell-old

This directory preserves the old tmux-backed cli-shell implementation. It is no longer the target of `agenter shell`; the official Shell product now lives in `extensions/shell`.

...
- In cli-shell, Shell truth is the current TerminalSystem terminal bound to the active cli-shell product resource.
...
- Handling multiple cli-shell sessions is allowed. Keep their identities explicit, prefer the room-bound cli-shell product binding for room conversation, and use the cli-shell cleanup command when stale cli-shell runtime resources need to be removed.

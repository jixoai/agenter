...
describe("Feature: shell minimal four-pane layout", () => {
...
describe("Feature: shell tmux-like layout mutations", () => {
...
describe("Feature: shell tmux minimum-size parity", () => {
  test("Scenario: Given tmux split rules When checking split minimum Then shell requires two cells plus a separator", () => {

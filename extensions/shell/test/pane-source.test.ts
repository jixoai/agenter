...
import { ShellLiveTerminalProtocolSource } from "../src/sources/shell-live-terminal-source";
...
describe("Feature: shell pane source normalization", () => {
  ...
  test("Scenario: Given a shell live terminal channel When normalized as shell source Then rich protocol facts are preserved", async () => {
    ...
    const source = new ShellLiveTerminalProtocolSource({

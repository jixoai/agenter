...
describe("Feature: cli-shell shell pane cursor projection", () => {
  ...
  test("Scenario: Given the product shell pane mounts a terminal instance panel When cli-shell restores the frame-backed shell surface Then it reserves one gutter column for the scrollbar and resizes backend truth to the content viewport", async () => {

import { getHeartbeatToolVisualHint, type HeartbeatToolVisualHint } from "./heartbeat-tool-visual-hints";
import type { HeartbeatGroupItem, HeartbeatPartItem, HeartbeatToolUiState } from "./types";
...
const parseHeartbeatToolTracePart = (part: HeartbeatPart): ParsedToolTrace | null => {
  ...
  const state: HeartbeatToolUiState =

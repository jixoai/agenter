...
export type ProductDelegationListOutput = RouterOutputs["productExtension"]["listDelegations"];
export type ProductDelegationRecord = ProductDelegationListOutput["items"][number];
export type ProductDelegationCreateOutput = RouterOutputs["productExtension"]["createDelegation"];
export type ProductDelegationRevokeOutput = RouterOutputs["productExtension"]["revokeDelegation"];

...
export type McpInspectorStartInput = RouterInputs["mcp"]["inspectorStart"];
export type McpInspectorStartOutput = RouterOutputs["mcp"]["inspectorStart"];
export type McpInspectorSnapshotInput = RouterInputs["mcp"]["inspectorSnapshot"];
export type McpInspectorSnapshotOutput = RouterOutputs["mcp"]["inspectorSnapshot"];
...
export type HeartbeatRecordProjectionRepairOutput = RouterOutputs["runtime"]["repairHeartbeatRecordProjectionHealth"];
export type HeartbeatSessionClearOutput = RouterOutputs["runtime"]["clearHeartbeatSession"];

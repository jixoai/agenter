...
describe("Feature: App icon asset pipeline", () => {
  test("Scenario: Given generated WebUI static assets When checking the filesystem Then favicon and PWA outputs stay present at canonical paths", () => {
    const missing = [
      "favicon.ico",
  ...
  test("Scenario: Given the site manifest When reading icon entries Then the WebUI exposes both any and maskable icon contracts", () => {

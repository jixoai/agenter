...
export type AttentionDetailView = "context" | "items";
...
const normalizeAttentionView = (value: unknown): AttentionDetailView => (value === "items" ? "items" : "context");
...
export const validateSessionDevtoolsSearch = (search: Record<string, unknown>): SessionDevtoolsSearch => {
  ...
  return {
    ...
    attentionView: normalizeAttentionView(search.attentionView),
    attentionQuery: readSearchString(search.attentionQuery),
  };
};

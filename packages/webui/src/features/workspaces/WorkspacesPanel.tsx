...
export const WorkspacesPanel = ({
  ...
  return (
    <>
      <section className="relative flex h-full flex-col overflow-hidden rounded-2xl bg-white p-4 shadow-sm">
        ...
        <div className="flex-1 space-y-4 overflow-auto">
          ...
          {filtered.length === 0 ? <p className="typo-caption text-slate-500">No workspace found.</p> : null}
        </div>
      </section>

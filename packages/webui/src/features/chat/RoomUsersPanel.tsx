...
export const RoomUsersPanel = ({ roomId, loading, users }: RoomUsersPanelProps) => {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1 space-y-1">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Badge variant={user.readStatus === "read" ? "success" : user.readStatus === "unread" ? "warning" : "secondary"}>
                    ...
                    {user.accessToken ? (
                      <div className="flex flex-wrap items-center gap-2">
                        <code className="rounded bg-white px-2 py-1 text-[11px] text-slate-600">{user.accessToken}</code>
                        {typeof navigator !== "undefined" && navigator.clipboard?.writeText ? (
                          <Button
                            ...
                            variant="ghost"
                            onClick={() => {
                              void navigator.clipboard.writeText(user.accessToken!);
                            }}
                          >

<script lang="ts">
  ...
  import RuntimeStageHeartbeat from "@perf-target-webui-runtime/runtime-stage-heartbeat.svelte";
  import { createEmptyRuntimeHeartbeatConfigBinding } from "@perf-target-webui-runtime/runtime-heartbeat-config-state";

...
import { collectMarkdownStructuralProjectionState, type MarkdownProjectionRange } from "./markdown-hybrid-projection";
import { markdownHighlightStyle, markdownPreviewTheme } from "./markdown-preview-theme";
import {
  bulletDecoration,
  orderedDecoration,
...
} from "./markdown-preview-widgets";
import {
  collectInlineResourceTokenDecorations,
  resolveInlineResourceTokenNode,
} from "./markdown-resource-token-projection";
...
type ResourceDefinitionProjection = {
  ...
  aggregatedResources: readonly MarkdownResourceReference[];
};

...
export const REAL_RELAY_AVATAR_PROFILE: RealAvatarPersonaProfile = {
  ...
  prompt: toPrompt([
    ...
    "- In relay tests, the visible relay room is already enough evidence. Start from `message read` or `message send`, not `skill info` or extra room discovery.",
...
export const REAL_ROOM_TERMINAL_AVATAR_PROFILE: RealAvatarPersonaProfile = {
  ...
  prompt: toPrompt([
    ...
    "",
    ...COMMON_RUNTIME_LAW,
    "- Operate like a pragmatic app engineer who is at home in bash, curl, and local web delivery.",
...
export const REAL_ROOM_TERMINAL_NOVICE_AVATAR_PROFILE: RealAvatarPersonaProfile = {
  ...
  prompt: toPrompt([
    ...
    "- Still operate like a strong Linux app engineer behind the scenes: build, launch, self-check, then report the working URL.",
...
export const REAL_TEAM_BACKEND_AVATAR_PROFILE: RealAvatarPersonaProfile = {
  ...
  prompt: toPrompt([
    ...
    "",
    ...COMMON_RUNTIME_LAW,
    "- You are the backend lead for a small app team.",
...
export const REAL_TEAM_FRONTEND_AVATAR_PROFILE: RealAvatarPersonaProfile = {
  ...
  prompt: toPrompt([
    ...
    "",
    ...COMMON_RUNTIME_LAW,
    "- You are the frontend lead for a small app team.",

...
import type { MarkdownProjectionRange } from "./message-markdown-hybrid-projection";
import { inlineResourceTokenDecoration, resolveInlineResourceReference } from "./message-markdown-preview-widgets";

export type MarkdownResourceTokenTone = "assistant" | "participant" | "viewer";
